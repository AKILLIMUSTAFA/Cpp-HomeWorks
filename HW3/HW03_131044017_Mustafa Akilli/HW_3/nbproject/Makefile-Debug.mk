...
${OBJECTDIR}/call_by_reference.o: call_by_reference.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/call_by_reference.o call_by_reference.cpp

${OBJECTDIR}/call_by_value.o: call_by_value.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/call_by_value.o call_by_value.cpp

${OBJECTDIR}/is_it_legal_triangle.o: is_it_legal_triangle.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/is_it_legal_triangle.o is_it_legal_triangle.cpp
...
${OBJECTDIR}/triangle_angleA.o: triangle_angleA.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/triangle_angleA.o triangle_angleA.cpp

${OBJECTDIR}/triangle_angleB.o: triangle_angleB.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/triangle_angleB.o triangle_angleB.cpp

${OBJECTDIR}/triangle_angleC.o: triangle_angleC.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/triangle_angleC.o triangle_angleC.cpp

${OBJECTDIR}/triangle_area.o: triangle_area.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/triangle_area.o triangle_area.cpp

${OBJECTDIR}/triangle_constructor.o: triangle_constructor.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/triangle_constructor.o triangle_constructor.cpp

${OBJECTDIR}/triangle_input.o: triangle_input.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/triangle_input.o triangle_input.cpp

${OBJECTDIR}/triangle_is_a_right_angle_triangle.o: triangle_is_a_right_angle_triangle.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/triangle_is_a_right_angle_triangle.o triangle_is_a_right_angle_triangle.cpp

${OBJECTDIR}/triangle_output.o: triangle_output.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/triangle_output.o triangle_output.cpp

${OBJECTDIR}/triangle_perimeter.o: triangle_perimeter.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/triangle_perimeter.o triangle_perimeter.cpp

${OBJECTDIR}/triangle_set.o: triangle_set.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/triangle_set.o triangle_set.cpp
