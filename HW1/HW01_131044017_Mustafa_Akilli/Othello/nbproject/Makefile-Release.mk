...
${OBJECTDIR}/board_size.o: board_size.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/board_size.o board_size.cpp

${OBJECTDIR}/does_player_have_move.o: does_player_have_move.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/does_player_have_move.o does_player_have_move.cpp

${OBJECTDIR}/does_player_have_move_is_it_legal_move.o: does_player_have_move_is_it_legal_move.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/does_player_have_move_is_it_legal_move.o does_player_have_move_is_it_legal_move.cpp

${OBJECTDIR}/does_player_have_move_reset_structs.o: does_player_have_move_reset_structs.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/does_player_have_move_reset_structs.o does_player_have_move_reset_structs.cpp
...
${OBJECTDIR}/does_player_have_move_which_ones_has_computer_icon_on_around.o: does_player_have_move_which_ones_has_computer_icon_on_around.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/does_player_have_move_which_ones_has_computer_icon_on_around.o does_player_have_move_which_ones_has_computer_icon_on_around.cpp

${OBJECTDIR}/does_player_have_move_which_ones_is_player_icon.o: does_player_have_move_which_ones_is_player_icon.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/does_player_have_move_which_ones_is_player_icon.o does_player_have_move_which_ones_is_player_icon.cpp

${OBJECTDIR}/first_view.o: first_view.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/first_view.o first_view.cpp

${OBJECTDIR}/for_computer_do_best_move.o: for_computer_do_best_move.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/for_computer_do_best_move.o for_computer_do_best_move.cpp

${OBJECTDIR}/for_computer_is_it_legal_move.o: for_computer_is_it_legal_move.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/for_computer_is_it_legal_move.o for_computer_is_it_legal_move.cpp

${OBJECTDIR}/for_computer_move.o: for_computer_move.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/for_computer_move.o for_computer_move.cpp

${OBJECTDIR}/for_computer_reset_structs.o: for_computer_reset_structs.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/for_computer_reset_structs.o for_computer_reset_structs.cpp

${OBJECTDIR}/for_computer_which_one_is_smartest_move.o: for_computer_which_one_is_smartest_move.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/for_computer_which_one_is_smartest_move.o for_computer_which_one_is_smartest_move.cpp

${OBJECTDIR}/for_computer_which_ones_has_player_icon_on_around.o: for_computer_which_ones_has_player_icon_on_around.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/for_computer_which_ones_has_player_icon_on_around.o for_computer_which_ones_has_player_icon_on_around.cpp

${OBJECTDIR}/for_computer_which_ones_is_empty_icon.o: for_computer_which_ones_is_empty_icon.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/for_computer_which_ones_is_empty_icon.o for_computer_which_ones_is_empty_icon.cpp

${OBJECTDIR}/for_player_is_it_empty_icon.o: for_player_is_it_empty_icon.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/for_player_is_it_empty_icon.o for_player_is_it_empty_icon.cpp

${OBJECTDIR}/for_player_is_it_legal_move.o: for_player_is_it_legal_move.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/for_player_is_it_legal_move.o for_player_is_it_legal_move.cpp

${OBJECTDIR}/for_player_move.o: for_player_move.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/for_player_move.o for_player_move.cpp
...
${OBJECTDIR}/paint_board.o: paint_board.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/paint_board.o paint_board.cpp

${OBJECTDIR}/scoreboard.o: scoreboard.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/scoreboard.o scoreboard.cpp
